...
const HeaderI18n = ({
  ...
  isSelected,
  selectBlockFun,
}: HeaderI18nProp ): React.ReactElement => {
    ...
    <>
      {
        headingType === "h1" && (
          ...
          >{ text[locale] ? text[locale] : text }</h1>
        )
      }
      {
        headingType === "h2" && (
          <h2
            ...
            onClick={selectBlockFun}
          >{ text[locale] ? text[locale] : text }</h2>
        )
      }
      {
        headingType === "h3" && (
          <h3
            ...
            onClick={selectBlockFun}
          >{ text[locale] ? text[locale] : text }</h3>
        )
      }
      {
        headingType === "h4" && (
          <h4
            ...
            onClick={selectBlockFun}
          >{ text[locale] ? text[locale] : text }</h4>
        )
      }
      {
        headingType === "h5" && (
          <h5
            ...
            onClick={selectBlockFun}
          >{ text[locale] ? text[locale] : text }</h5>
        )
      }
      {
        headingType === "h6" && (
          <h6
            ...
            onClick={selectBlockFun}
          >{ text[locale] ? text[locale] : text }</h6>
        )
      }
    </>
  );
...
export default React.memo(HeaderI18n);
